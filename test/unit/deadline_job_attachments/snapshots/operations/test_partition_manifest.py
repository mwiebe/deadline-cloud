...
from deadline.job_attachments._snapshots import partition_manifest, SymlinkPolicy
from deadline.job_attachments._snapshots._operations._partition_manifest import (
    _is_absolute_path,
    _is_path_under_root,
